...
INSERT INTO course_instance (layout_id, study_year, study_period, num_students)
VALUES
(9,  2025, 'P1', 150),   
(11, 2025, 'P2', 200),   
(7,  2025, 'P2', 180),   
...
INSERT INTO allocation (activity_id, instance_id, worker_id, allocated_hours) VALUES
-- ID2214 (instance_id = 5)
(1,5,2,80),(1,5,3,40),(1,5,4,60),(1,5,5,20),(1,5,6,0),
(2,5,2,0),(2,5,3,30),(2,5,4,20),(2,5,5,50),(2,5,6,0),
(3,5,2,0),(3,5,3,40),(3,5,4,70),(3,5,5,40),(3,5,6,0),
(4,5,2,0),(4,5,3,0),(4,5,4,0),(4,5,5,0),(4,5,6,0),

-- IV1350 (instance_id = 6)
(1,6,2,50),(1,6,3,30),(1,6,4,0),(1,6,5,20),(1,6,6,0),
(2,6,2,0),(2,6,3,20),(2,6,4,40),(2,6,5,0),(2,6,6,40),
(3,6,2,10),(3,6,3,0),(3,6,4,20),(3,6,5,20),(3,6,6,0),
(4,6,2,0),(4,6,3,0),(4,6,4,0),(4,6,5,0),(4,6,6,0),

-- IV1351 (instance_id = 4)
(1,4,2,100),(1,4,3,50),(1,4,4,0),(1,4,5,0),(1,4,6,50),
(2,4,2,0),(2,4,3,40),(2,4,4,40),(2,4,5,0),(2,4,6,20),
(3,4,2,30),(3,4,3,0),(3,4,4,40),(3,4,5,80),(3,4,6,0),
(4,4,2,0),(4,4,3,0),(4,4,4,0),(4,4,5,0),(4,4,6,0),

-- IX1500 (instance_id = 3)
(1,3,2,0),(1,3,3,100),(1,3,4,50),(1,3,5,0),(1,3,6,0),
(2,3,2,50),(2,3,3,0),(2,3,4,0),(2,3,5,50),(2,3,6,0),
(3,3,2,70),(3,3,3,0),(3,3,4,0),(3,3,5,0),(3,3,6,80),
(4,3,2,0),(4,3,3,0),(4,3,4,0),(4,3,5,0),(4,3,6,0);
